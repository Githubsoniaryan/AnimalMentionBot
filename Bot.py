...
async def help(event):
    ...
    await event.reply(
        ...
        buttons=(
            [
                Button.url(" Gʀᴏᴜᴘ ", "https://t.me/royalgroupop"),
                Button.url(" Cʜᴀɴɴᴇʟ ", "https://t.me/itsRareBeautySelenaGomez"),
            ]
        ),
    )
